...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'abac258b-003e-44e8-84d0-3ea0ba6c7a7e' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('61906042-6ee6-45c4-bf72-c83b3cf1e2b3');
      cy.get(`[data-cy="name"]`).should('have.value', '61906042-6ee6-45c4-bf72-c83b3cf1e2b3');
